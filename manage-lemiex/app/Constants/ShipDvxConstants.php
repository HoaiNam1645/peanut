...
class ShipDvxConstants
{
    ...
    // orderNumber hard cap: ShipDVX rejects "orderNumber must NOT have more than
    // 36 characters". Long refs (K-Seller[..]-Store[..]-<orderId>) fall back to the
    // trailing platform order id (see BuyLabelService::resolveOrderNumber).
    const MAX_ORDER_NUMBER_LEN = 36;
