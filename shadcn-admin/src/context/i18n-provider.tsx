  ...
  vi: {
    ...
    orders: {
      ...
      createOrderDialog: {
        ...
        tumblerLabelShipDesc:
          'Đơn gỗ dùng nhãn vận chuyển có sẵn.',
        tumblerSellerShipTitle: 'Seller Ship',
        tumblerSellerShipDesc:
          'Đơn gỗ dùng địa chỉ nhận hàng.',
      },
      createForm: {
        ...
        productsAndDesignFilesDesc:
          'Thêm sản phẩm gỗ, mockup và file thiết kế cho đơn hàng.',
    ...
    productVariants: {
      ...
      createForm: {
        ...
        brand: 'Nhà cung cấp',
        warehouse: 'Kho',
        productNamePlaceholder: 'vd. Hộp gỗ khắc laser',
        stylePlaceholder: 'vd. Box-S',
        brandPlaceholder: 'vd. Xưởng Gỗ Việt',
  ...
  en: {
    ...
    orders: {
      ...
      createOrderDialog: {
        ...
        tumblerLabelShipTitle: 'Label Ship',
        tumblerLabelShipDesc:
          'Wood orders with a pre-existing shipping label.',
        tumblerSellerShipTitle: 'Seller Ship',
        tumblerSellerShipDesc:
          'Wood orders with a delivery address.',
      },
      createForm: {
        ...
        productsAndDesignFilesDesc:
          'Add wood products, mockups and design files for this order.',
    ...
    productVariants: {
      ...
      createForm: {
        ...
        brand: 'Supplier',
        warehouse: 'Warehouse',
        productNamePlaceholder: 'e.g., Laser Engraved Wood Box',
        stylePlaceholder: 'e.g., Box-S',
        brandPlaceholder: 'e.g., Wood Workshop VN',
